    ...
    return (
        <div className="h-full flex flex-col border-r overflow-hidden">
            ...
            <div className="flex-shrink-0 px-3 pt-3 pb-2 border-b space-y-1.5">
                ...
                {isEditingName ? (
                    <div className="space-y-1.5">
                        <Input value={editName} onChange={(e) => setEditName(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleSaveEdit()} placeholder="Name" autoFocus className="text-sm font-semibold h-8" />
                        <Input value={editDesc} onChange={(e) => setEditDesc(e.target.value)} placeholder="Description" className="text-xs h-7" />
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <Button size="icon" variant="ghost" onClick={() => setSettingsOpen(true)} className="h-6 w-6 flex-shrink-0" title="Workspace settings">
            ...
            <div className="flex-shrink-0 px-3 py-1.5 flex items-center justify-between border-t border-b">
                <h3 className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider">Add Documents</h3>
