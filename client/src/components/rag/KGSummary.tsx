...
export const KGSummary = memo(function KGSummary({ summary }: KGSummaryProps) {
    ...
    return (
        <div className="rounded-lg border bg-primary/5 border-primary/20 overflow-hidden">
            <button onClick={() => setExpanded(!expanded)} className="flex items-center justify-between w-full px-4 py-2.5 hover:bg-primary/10 transition-colors">
                <div className="flex items-center gap-2">
                    <Brain className="w-4 h-4 text-primary" />
                    <span className="text-sm font-medium text-primary">Tong quan Knowledge Graph</span>
                </div>
